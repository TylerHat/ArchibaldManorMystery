...
hand-placement walkthrough in `.claude/reference/build-gui-geometry-superseded.md`.

**`.claude/reference/build-gui-geometry-superseded.md` is superseded. Do not keep working through Part 4.**
...
the four wall sizes, matching the table in `.claude/reference/build-gui-geometry-superseded.md` exactly.
...
```gdscript
## The manor is generated by ManorBuilder (see .claude/reference/manor-builder.md). This just
